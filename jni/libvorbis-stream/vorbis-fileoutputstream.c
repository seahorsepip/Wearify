 ...
 */
jint Java_com_seapip_thomas_wearify_libogg_VorbisFileOutputStream_create(
        JNIEnv* env,
        jobject this,
        jstring path,
        jobject info
 ...
 *
 */
void Java_com_seapip_thomas_wearify_libogg_VorbisFileOutputStream_writeStreamIdx(
        JNIEnv* env,
        jobject this,
        jint sidx,
        jshortArray pcm,
 ...
 */
void Java_com_seapip_thomas_wearify_libogg_VorbisFileOutputStream_closeStreamIdx(
        JNIEnv* env,
        jobject this,
        jint sidx
        )
