...
jint Java_com_seapip_thomas_wearify_libogg_VorbisFileInputStream_create(
		JNIEnv* env,
		jobject this,
		jstring path,
		jobject info
...
jint Java_com_seapip_thomas_wearify_libogg_VorbisFileInputStream_readStreamIdx(
		JNIEnv* 	env,
		jobject 	this,
		jint		sidx,
		jshortArray pcm,
...
jlong Java_com_seapip_thomas_wearify_libogg_VorbisFileInputStream_skipStreamIdx(
		JNIEnv* 	env,
		jobject 	this,
		jint		sidx,
		jlong 		offset
...
void Java_com_seapip_thomas_wearify_libogg_VorbisFileInputStream_closeStreamIdx(
		JNIEnv* 	env,
		jobject 	this,
		jint		sidx
		)
